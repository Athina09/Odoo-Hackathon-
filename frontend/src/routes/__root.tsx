...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Environmental, Social & Governance performance dashboard for Odoo Hackathon." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "EcoSphere — ESG Platform" },
      { property: "og:description", content: "ESG management platform for Odoo Hackathon." },
